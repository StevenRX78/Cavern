...
if pgzero_version < [1,2]:
    print("This game requires at least version 1.2 of Pygame Zero. You"
          "have version {0}. Please upgrade using the command"
          "'pip3 install --upgrade pgzero'".format(pgzero.__version__))
    sys.exit()
